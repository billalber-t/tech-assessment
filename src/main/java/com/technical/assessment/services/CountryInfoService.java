...
//            return extractFullCountryInfoDTO(responseXml);
//
//        } catch (Exception e) {
//            log.error("Error while calling SOAP API", e);
//            return null;
...
//    private FullCountryInfoDTO extractFullCountryInfoDTO(String responseXml) {
//        FullCountryInfoDTO countryInfo = new FullCountryInfoDTO();
//
//        String patternString = "<m:FullCountryInfoDTOResult>(.*?)</m:FullCountryInfoDTOResult>";
